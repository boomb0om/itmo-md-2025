...
### 6. Analysis (Визуализации и Инсайты)
**Директория**: `analysis/`

Jupyter ноутбук с комплексным анализом данных и визуализациями:
- **6 типов визуализаций**: Price dynamics, Volatility, Sentiment analysis, Candlestick charts, Correlation matrix, Trading volume
- **Автоматические инсайты**: Тренды, риски, влияние новостей, торговые рекомендации
- **Источники данных**: Data Mart слой (dm.dm_crypto_market_overview, dm.dm_news_impact_analysis)

**Технологии**: Jupyter, Pandas, Matplotlib, Seaborn, NumPy

См. `analysis/README.md` для подробностей.
...
├── analysis/                         # Визуализации и анализ
│   ├── crypto_data_analysis.ipynb    # Jupyter ноутбук с инсайтами
│   ├── requirements.txt              # Python зависимости
│   └── README.md                     # Документация по анализу
...
- 3 инкрементальные стратегии (delete+insert, append, table)

✅ **Визуализация (10 баллов)**:
- Jupyter ноутбук с 6 типами визуализаций
- Автоматические инсайты и выводы
- Корреляционный анализ
- Торговые рекомендации на основе данных

**Итого**: 90/120 баллов
**Дополнительно есть**: презентация (+10 баллов)
